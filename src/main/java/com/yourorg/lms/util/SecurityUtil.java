...
public final class SecurityUtil {
    ...
    public static String hash(String input) {
        ...
        try {
            ...
            // .trim() here is a lifesaver—it removes leading/trailing spaces before hashing
    ...
    public static boolean verifyPassword(String rawPassword, String storedHash) {
        ...
        // We hash the raw input and compare it to the stored hash.
        // We use .trim() on storedHash in case the file reading added a space.
